...
//			}
	...
	//		Thread.sleep(10000);
			String[] args1 = {"USER1"};
			Logger.getLogger(QueryChaincode.class.getName()).log(Level.INFO, "Querying for a user - " + args1[0]);
			
			Collection<ProposalResponse>  responses1Query = channelClient.queryByChainCode("usercredentials", "queryUser", args1);
